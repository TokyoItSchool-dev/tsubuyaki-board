...
class PostControllerTest {
    ...
    @Test
    @DisplayName("投稿一覧_GET_posts_最新50件を新着順のままビューに渡す")
    void 投稿一覧_GET_posts_最新50件を新着順のままビューに渡す() throws Exception {
        ...
        given(postService.latest(50)).willReturn(latestPosts);
