...
MERGE INTO posts (id, author, body, avatar_color, created_at) KEY(id) VALUES
    (1,  'tanaka',  '朝会メモを共有しました。今日の確認事項は投稿一覧の表示順です。', 'blue', TIMESTAMP '2026-06-26 09:00:00'),
    (2,  'suzuki',  'H2 プロファイルで軽量に起動できるようにしました。', 'green', TIMESTAMP '2026-06-26 09:08:00'),
    (3,  'sato',    'レビュー観点: th:text で表示して XSS を防ぐ。', 'red', TIMESTAMP '2026-06-26 09:16:00'),
    ...
    (6,  'yamada',  'Service は Spring を起動せず Mockito で検証します。', 'blue', TIMESTAMP '2026-06-26 09:40:00'),
    (7,  'nakamura', 'Controller は MockMvc でビュー名と model を確認します。', 'green', TIMESTAMP '2026-06-26 09:48:00'),
    (8,  'kato',    'Flyway の migration は Oracle と H2 の両方で読める構文にします。', 'red', TIMESTAMP '2026-06-26 09:56:00'),
